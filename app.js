    ...
    Utils.executeDestination({
        ...
        let response1 = {
            "replies": [
                {
                    "type": "text",
                    "content": "The current approver2 for " + transaction + " is " + ("current-approval" in record[0] ? record[0]["current-approval"]["approver"]["name"] : record[transaction_id]["current-approval"]["approver"]["name"] )
                }
            ]
        };
